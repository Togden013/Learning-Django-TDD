...
class NewVisitorTest(LiveServerTestCase):
    ...
    def check_for_row_in_list_table(self, *row_texts):
    ...
    def test_can_start_a_list_and_retireve_it_later(self):
        # Edith has heard about a cool new online to-to app. She goes
        ...
        # She types "Buy peakcock feathers" into a text box (Edith's hobby
